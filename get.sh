rm -rf tracks images lyrics && mkdir tracks images lyrics
...
cd lyrics && git init && git remote add origin https://github.com/xmp3/lyrics && git branch -m $1 && git pull origin $1 && cd ..
